...
Date: {meeting_date}
{tldr_line}
{task_count} action items captured. Full meeting summary is attached as a Word document.
...
"""
        ...
        # Build clean HTML body (brief intro, not full content)
        tldr_html = (
...
<p>{task_count} action items captured. Full meeting summary is attached as a Word document.</p>
